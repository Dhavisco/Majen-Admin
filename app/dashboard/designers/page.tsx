        ...
        <DashboardLayout>
            <div className="space-y-6 p-2 md:p-0">
                ...
                <main className='bg-white rounded-xl border shadow-sm py-2 px-4'>
                    ...
                    {/* Search + Actions */}
                    <div className="flex flex-col sm:flex-row sm:justify-between gap-10 w-full mt-4">
                                    ...
                                    <TableRow key={designer.id} className="hover:bg-muted/50 transition-colors">
                                        ...
                                        <TableCell>
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div className="w-9 h-9 bg-linear-to-br from-[#1A0089] to-indigo-600 text-white rounded-full flex items-center justify-center font-medium text-sm">
                                        ...
                                        <TableCell className="font-medium">{designer.business}</TableCell>

                                        <TableCell className="text-muted-foreground font-mono">{designer.cac}</TableCell>

                                        <TableCell>{designer.products}</TableCell>

                                        <TableCell className="text-muted-foreground">{designer.joined}</TableCell>
                                        ...
                                        <TableCell>
                                            ...
                                            <div className="flex gap-2">
                                                ...
                                                {designer.status === 'Pending' ? (
                                                    ...
                                                    <>
                                                        <Button size="sm" className="bg-[#1A0089] hover:bg-[#14006b] font-medium">
                                                            <FaCheck className="mr-1" /> Verify
                                                        </Button>

                                                        <Button size="sm" variant="outline" className="border-red-500 text-red-600 hover:bg-red-100 font-medium">
                                                            <FaTimes className="mr-1" /> Reject
                                                        </Button>

                                                        <Button size="sm" variant="outline" className='text-[#1A0089] hover:bg-[#14006b] border-[#1900894b] font-medium'>
                                                            View
                                                        </Button>
                                                    </>
                                ...
                                <Pagination>
                                    <PaginationContent>
                                        <PaginationItem>
                                            <PaginationPrevious
                                                href="#"
                                                className="text-[#1A0089]! hover:text-[#14006b] border-[#1A00894b] border-[0.5px]"
                                            />
                                        </PaginationItem>
                                        <PaginationItem>
                                            <PaginationLink
                                                href="#"
                                                isActive
                                                className="bg-[#1A0089] text-white! hover:bg-[#14006b]"
                                            >
                                                1
                                            </PaginationLink>
                                        </PaginationItem>
                                        <PaginationItem>
                                            <PaginationLink
                                                href="#"
                                                className="text-[#1A0089]! hover:bg-[#1A0089]/10 hover:text-[#14006b]! border-[#1A00894b] border-[0.5px]"
                                            >
                                                2
                                            </PaginationLink>
                                        </PaginationItem>
